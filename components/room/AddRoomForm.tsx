          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea
                    placeholder="Enjoy fresh mountain air from this room!"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
          ...
          <div className="flex flex-row gap-6">
            <div className="flex-1 flex flex-col gap-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Room Price in RON *</FormLabel>
                    <FormDescription>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Number of available beds.</FormDescription>
                    <FormControl>
            ...
            <div className="flex-1 flex flex-col gap-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Breakfast Price in RON</FormLabel>
                    <FormDescription>
                      State the price for staying in this room for 24h
                    </FormDescription>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      How many king beds are available.
                    </FormDescription>
                    <FormControl>
                      <Input type="number" min={0} max={8} {...field} />
                    </FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      How many queen beds are available.
                    </FormDescription>
                    <FormControl>
                      <Input type="number" min={0} max={8} {...field} />
                    </FormControl>
